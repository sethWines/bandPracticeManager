 ...
 * Requires js/app-shell.js loaded first (file:// compatible).
 */

if (typeof BandAppShell === 'undefined') {
    console.error('Band Practice Manager: load js/app-shell.js before storage-wizard.js');
} else {
    BandAppShell.exposeShellOnWindow();
}
...
document.addEventListener('DOMContentLoaded', function() {
    loadTheme({ defaultTheme: 'red' });
    applyWatermarkFromStorage();
